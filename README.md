# Smiley Rating
SmileyRating is a simple rating bar which for android. It displayes animated smileys as rating icon.
  - Drawn completely using android canvas
  - Inspired by [Bill Labus](https://dribbble.com/shots/2790473-Feedback)

## Demo
 
![alttg](https://raw.githubusercontent.com/sujithkanna/SmileyRating/master/app/src/main/assets/demo.gif)
...
```groovy
compile 'com.github.sujithkanna:smileyrating:1.3'
```
